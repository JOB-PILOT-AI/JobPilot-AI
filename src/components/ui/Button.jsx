export default function Button({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-semibold tracking-[0.01em] transition-all duration-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-0 disabled:translate-y-0 disabled:opacity-70'
